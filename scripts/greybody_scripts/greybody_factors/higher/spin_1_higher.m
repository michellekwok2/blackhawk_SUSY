...
(* ::Input::Initialization:: *)
V1[r_,M_,Mstar_,n_,l_]:=nu1[l]*G[r,M,Mstar,n]/H[r];
...
rpinf = rstar[rH[M,Mstar,n]+far,M,Mstar,n]},tortoise=NDSolve[{r'[rs]==1-(rH[M,Mstar,n]/r[rs])^(n+1),{r[rminf]==rH[M,Mstar,n]+prox}},r,{rs,rminf,rpinf},Method->"StiffnessSwitching",AccuracyGoal->18,PrecisionGoal->18];NDSolve[{X''[rs]+omega^2*X[rs]==V1[coord[rs],M,Mstar,n,l]*X[rs],{X[rminf]== Ainh*Exp[-I*omega*rminf],X'[rminf] == -I*omega*Ainh*Exp[-I*omega*rminf]}},X,{rs,rminf,rpinf},Method->"StiffnessSwitching",AccuracyGoal->18,PrecisionGoal->10]];


(* ::Input::Initialization:: *)
SetDirectory[NotebookDirectory[]];
file1=OpenWrite["fM_higher_1_low.txt"];
