...
(* ::Input::Initialization:: *)
V2[r_,M_,rQ_,l_]:=nu2[l]*G[r,M,rQ]/H[r] + F[r,M,rQ]*G[r,M,rQ]/(2*H[r]^2)*(D[H[u],u]/.{u->r})^2 - 1/2*Sqrt[F[r,M,rQ]*G[r,M,rQ]/H[r]]*D[Sqrt[F[u,M,rQ]*G[u,M,rQ]/H[u]]*H'[u],u]/.{u-> r};
...
rpinf = rstar[rplus[M,rQ]+far,M,rQ]},tortoise=NDSolve[{r'[rs]==(r[rs] - rplus[M,rQ])*(r[rs]-rminus[M,rQ])/r[rs]^2,{r[rminf]==rplus[M,rQ]+prox}},r,{rs,rminf,rpinf},Method->"StiffnessSwitching",AccuracyGoal->18,PrecisionGoal->18];NDSolve[{X''[rs]+omega^2*X[rs]==V2[coord[rs],M,rQ,l]*X[rs],{X[rminf]== Ainh*Exp[-I*omega*rminf],X'[rminf] == -I*omega*Ainh*Exp[-I*omega*rminf]}},X,{rs,rminf,rpinf},Method->"StiffnessSwitching",AccuracyGoal->18,PrecisionGoal->10]];


(* ::Input::Initialization:: *)
SetDirectory[NotebookDirectory[]];
file1=OpenWrite["fM_charged_2_low.txt"];
