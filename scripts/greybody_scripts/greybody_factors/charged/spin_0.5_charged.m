...
(* ::Input::Initialization:: *)
epsilon = 1;
V12[r_,M_,rQ_,l_]:=nu12[l]*G[r,M,rQ]/H[r] + epsilon*Sqrt[nu12[l]*F[r,M,rQ]*G[r,M,rQ]]*D[Sqrt[G[u,M,rQ]/H[u]],u]/.{u->r};
...
rpinf = rstar[rplus[M,rQ]+far,M,rQ]},tortoise=NDSolve[{r'[rs]==(r[rs] - rplus[M,rQ])*(r[rs]-rminus[M,rQ])/r[rs]^2,{r[rminf]==rplus[M,rQ]+prox}},r,{rs,rminf,rpinf},Method->"StiffnessSwitching",AccuracyGoal->18,PrecisionGoal->18];NDSolve[{X''[rs]+omega^2*X[rs]==V12[coord[rs],M,rQ,l]*X[rs],{X[rminf]== Ainh*Exp[-I*omega*rminf],X'[rminf] == -I*omega*Ainh*Exp[-I*omega*rminf]}},X,{rs,rminf,rpinf},Method->"StiffnessSwitching",AccuracyGoal->18,PrecisionGoal->10]];


(* ::Input::Initialization:: *)
SetDirectory[NotebookDirectory[]];
file1=OpenWrite["fM_charged_0.5_low.txt"];
