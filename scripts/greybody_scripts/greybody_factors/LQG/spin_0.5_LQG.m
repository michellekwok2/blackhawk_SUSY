...
(* ::Input::Initialization:: *)
choice = 1;
V12[r_,M_,epsilon_,a0_,l_]:=nu12[l]*G[r,M,epsilon,a0]/H[r,a0] + choice*Sqrt[nu12[l]*F[r,M,epsilon,a0]*G[r,M,epsilon,a0]]*D[Sqrt[G[u,M,epsilon,a0]/H[u,a0]],u]/.{u->r};
...
rpinf = rstar[rplus[M,epsilon]+far,M,epsilon,a0]},tortoise=NDSolve[{r'[rs]==r[rs]^2*(r[rs]-rplus[M,epsilon])*(r[rs]-rminus[M,epsilon])/(r[rs]^4+a0^2),{r[rminf]==rplus[M,epsilon]+prox}},r,{rs,rminf,rpinf},Method->"StiffnessSwitching",AccuracyGoal->18,PrecisionGoal->18];NDSolve[{X''[rs]+omega^2*X[rs]==V12[coord[rs],M,epsilon,a0,l]*X[rs],{X[rminf]== Ainh*Exp[-I*omega*rminf],X'[rminf] == -I*omega*Ainh*Exp[-I*omega*rminf]}},X,{rs,rminf,rpinf},Method->"StiffnessSwitching",AccuracyGoal->18,PrecisionGoal->10]];


(* ::Input::Initialization:: *)
SetDirectory[NotebookDirectory[]];
file1=OpenWrite["fM_LQG_0.5_low_a0.txt"];
